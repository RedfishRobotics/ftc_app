...
public class GoldAlignDetector extends DogeCVDetector {
    ...
    public double alignSize       = 200;  // How wide is the margin of error for alignment
    ...
    public Mat process(Mat input) {
        ...
        if(bestRect != null){
            ...
            // Draw center point
            Imgproc.circle(displayMat, new Point( xPos, bestRect.x + (bestRect.height / 2)), 5, new Scalar(0,255,0),2);
