 ...
 */
@Autonomous(name = "Redfish_auto_audience_stone_red", group = "Sensor")
@Disabled
public class Redfish_auto_audience_stone_1_red extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            autoLibrary.RightIntakeMotor.setPower(0.8);
            autoLibrary.LeftIntakeMotor.setPower(0.8);
            encoderDrive(0.8, 16, 16, 5);
            sleep(250);
            encoderDrive(0.8, -23, -23, 5);
            sleep(250);
            autoLibrary.glyphStop.setPosition(0.85);
            sleep(200);
            autoLibrary.leftFlip.setPosition(0.15);
            autoLibrary.rightFlip.setPosition(0.85);
            sleep(750);
            gyroTurn(0.8, -90, 0.011);
            sleep(250);
            autoLibrary.leftFlip.setPosition(0.65);
            autoLibrary.rightFlip.setPosition(0.35);
            sleep(250);
            encoderDrive(0.8, 5, 5, 5);
            sleep(250);
