 ...
 */
@Autonomous(name = "Redfish_auto_back_stone_red", group = "Sensor")
@Disabled
public class Redfish_auto_back_stone_1_red extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (vuMark.equals(RelicRecoveryVuMark.CENTER)) {
                ...
                sleep(500);
                encoderStrafeRight(0.5, 14, 14, 5);
                ...
                gyroTurn(0.5, 0, 0.011);
                sleep(500);
                encoderStrafeRight(0.5, 21, 21, 5);
