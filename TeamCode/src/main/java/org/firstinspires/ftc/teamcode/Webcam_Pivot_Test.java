...
@Autonomous(name="Auto Webcam Pan Test", group="Linear Opmode")

public class Webcam_Pivot_Test extends LinearOpMode {
...
//                encoderDrive(0.4, 20,4, false, 2, true, false, 0);
    ...
    public  void webcamScan(){//The method for the webcam sampling for the gold mineral
        while(opModeIsActive()){
            panServo.setPosition(0.65);//turn the pan servo to the left position
            sleep(1000);
            if(detector.getAligned()){//scans from the gold mineral
                ...
                panServo.setPosition(0.49);//if not seen the pan servo turns to the center position
            }
            sleep(1000);
            if(detector.getAligned()){//scans from the gold mineral
                ...
                panServo.setPosition(0.35);//if not seen the pan servo turns to the center position
            }
            sleep(1000);
